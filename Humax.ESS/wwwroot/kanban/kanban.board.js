    ...
    function $_taskSortable() {
        $('[data-sortable="true"]').sortable({
            ...
            start: function (event, ui) {
                _src_code = ui.item.parent().parent().parent().attr('data-section');
                _data_status = ui.item.parent().parent().parent().attr('data-status');
                //console.log(_data_status);
            },
            change: function (event, ui) {
                //if (typeof _data_status != 'undefined' && _data_status == 'done') {
            ...
            stop: function (event, ui) {
                _dst_code = ui.item.parent().parent().parent().attr('data-section');
                //console.log('src: ' + _src_code + ' ~ dst: ' + _dst_code);
                _src_code = '';
                _dst_code = '';
                _data_status = '';
            },
