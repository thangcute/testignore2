...
using Humax.ESS.Localization.Internal;

namespace Humax.ESS.Localization
{
    using Humax.ESS.Localization.Caching;
    ...
    public class JsonStringLocalizerFactory : IStringLocalizerFactory
    {
        ...
        public IStringLocalizer Create(Type resourceSource)
        {
            ...
            var typeName = $"{assemblyName}.{typeInfo.Name}" == typeInfo.FullName
                ? typeInfo.Name
                : (typeInfo.FullName.StartsWith(assemblyName) ? typeInfo.FullName.Substring(assemblyName.Length + 1) : typeInfo.FullName);
